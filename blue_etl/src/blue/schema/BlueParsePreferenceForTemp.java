 ...
 *
 */
public class BlueParsePreferenceForTemp implements IParsePreference {

  /**
   *
   */
  public BlueParsePreferenceForTemp() {
  }
  ...
  public void applyPreference(TableSchema tableSchema) {
    ...
    int inDate = 0;
    int inValue = 0;
    tableSchema.setTableName(tableSchema.getTableName()+"_Temp");
  ...
  public String getConstraintsScripts(TableSchema tableSchema) {
    String tableName = tableSchema.getTableName()+"_Temp";
  ...
  public String getPostTableScripts(TableSchema tableSchema) {
    if (tableSchema.isWorkingTable())
      return "exec sp_Register_Interface_File '"+tableSchema.getTableName()+"_Temp"+"'\n";
    return "";
  }
